            ...
            <table class="line-items-container">
                <thead>
                    <tr>
                        ...
                        @if($sale->details->some(fn($d) => ($d->discount ?? 0) > 0))
                ...
                <tbody>
                    ...
                    $hasAnyDiscount = $sale->details->some(fn($d) => ($d->discount ?? 0) > 0);
                    @endphp
